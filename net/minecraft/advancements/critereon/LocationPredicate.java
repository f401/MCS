...
public record LocationPredicate(Optional<LocationPredicate.PositionPredicate> position, Optional<ResourceKey<Biome>> biome, Optional<ResourceKey<Structure>> structure, Optional<ResourceKey<Level>> dimension, Optional<Boolean> smokey, Optional<LightPredicate> light, Optional<BlockPredicate> block, Optional<FluidPredicate> fluid) {
   ...
   private static Optional<LocationPredicate> of(Optional<LocationPredicate.PositionPredicate> pPostition, Optional<ResourceKey<Biome>> pBiome, Optional<ResourceKey<Structure>> pStructure, Optional<ResourceKey<Level>> pDimension, Optional<Boolean> pSmokey, Optional<LightPredicate> pLight, Optional<BlockPredicate> pBlock, Optional<FluidPredicate> pFluid) {
      return pPostition.isEmpty() && pBiome.isEmpty() && pStructure.isEmpty() && pDimension.isEmpty() && pSmokey.isEmpty() && pLight.isEmpty() && pBlock.isEmpty() && pFluid.isEmpty() ? Optional.empty() : Optional.of(new LocationPredicate(pPostition, pBiome, pStructure, pDimension, pSmokey, pLight, pBlock, pFluid));
   }
   ...
   public static Optional<LocationPredicate> fromJson(@Nullable JsonElement pJson) {
   ...
   static record PositionPredicate(MinMaxBounds.Doubles x, MinMaxBounds.Doubles y, MinMaxBounds.Doubles z) {
      ...
      static Optional<LocationPredicate.PositionPredicate> of(MinMaxBounds.Doubles pX, MinMaxBounds.Doubles pY, MinMaxBounds.Doubles pZ) {
         return pX.isAny() && pY.isAny() && pZ.isAny() ? Optional.empty() : Optional.of(new LocationPredicate.PositionPredicate(pX, pY, pZ));
      }
