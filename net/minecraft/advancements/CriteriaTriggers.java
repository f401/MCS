...
public class CriteriaTriggers {
   ...
   public static <T extends CriterionTrigger<?>> T register(String pName, T pTrigger) {
      ...
      if (CRITERIA.putIfAbsent(resourcelocation, pTrigger) != null) {
   ...
   @Nullable
   public static ResourceLocation getId(CriterionTrigger<?> pTrigger) {
      return CRITERIA.inverse().get(pTrigger);
   }
