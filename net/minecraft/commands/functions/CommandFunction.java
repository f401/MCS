...
public interface CommandFunction<T> {
   ...
   static <T extends ExecutionCommandSource<T>> CommandFunction<T> fromLines(ResourceLocation pId, CommandDispatcher<T> pDispatcher, T pSource, List<String> pLines) {
