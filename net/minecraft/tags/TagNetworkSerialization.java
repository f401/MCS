...
public class TagNetworkSerialization {
   ...
   public static <T> void deserializeTagsFromNetwork(ResourceKey<? extends Registry<T>> pRegistryKey, Registry<T> pRegistry, TagNetworkSerialization.NetworkPayload pNetworkPayload, TagNetworkSerialization.TagOutput<T> pOutput) {
   ...
   public interface TagOutput<T> {
      void accept(TagKey<T> pTagKey, List<Holder<T>> pHolders);
   }
}