...
public class RegistryPatchGenerator {
   public static CompletableFuture<RegistrySetBuilder.PatchedRegistries> createLookup(CompletableFuture<HolderLookup.Provider> pLookup, RegistrySetBuilder pRegistrySetBuilder) {
      return pLookup.thenApply((p_309945_) -> {
         ...
         RegistrySetBuilder.PatchedRegistries registrysetbuilder$patchedregistries = pRegistrySetBuilder.buildPatch(registryaccess$frozen, p_309945_, cloner$factory);
