...
public class TextureMapping {
   ...
   public static TextureMapping trialSpawner(Block pTrialSpawnerBlock, String pSideSuffix, String pTopSuffix) {
      return (new TextureMapping()).put(TextureSlot.SIDE, getBlockTexture(pTrialSpawnerBlock, pSideSuffix)).put(TextureSlot.TOP, getBlockTexture(pTrialSpawnerBlock, pTopSuffix)).put(TextureSlot.BOTTOM, getBlockTexture(pTrialSpawnerBlock, "_bottom"));
   }
