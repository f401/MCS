...
public class BlockModelGenerators {
   ...
   private void copyDoorModel(Block pDoorBlock, Block pSourceBlock) {
      ...
      this.blockStateOutput.accept(createDoor(pSourceBlock, resourcelocation, resourcelocation1, resourcelocation2, resourcelocation3, resourcelocation4, resourcelocation5, resourcelocation6, resourcelocation7));
   }
   ...
   private BlockStateGenerator createCopperBulb(Block pBulbBlock, ResourceLocation pUnlit, ResourceLocation pUnlitPowered, ResourceLocation pLit, ResourceLocation pLitPowered) {
      return MultiVariantGenerator.multiVariant(pBulbBlock).with(PropertyDispatch.properties(BlockStateProperties.LIT, BlockStateProperties.POWERED).generate((p_308505_, p_308506_) -> {
         return p_308505_ ? Variant.variant().with(VariantProperties.MODEL, p_308506_ ? pLitPowered : pUnlitPowered) : Variant.variant().with(VariantProperties.MODEL, p_308506_ ? pLit : pUnlit);
      }));
   }
   ...
   class BlockFamilyProvider {
      ...
      public BlockModelGenerators.BlockFamilyProvider generateFor(BlockFamily pFamily) {
         this.family = pFamily;
         pFamily.getVariants().forEach((p_308515_, p_308516_) -> {
