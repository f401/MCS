...
public class TestCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> pDispatcher) {
      pDispatcher.register(Commands.literal("test").then(Commands.literal("runthis").executes((p_308552_) -> {
   ...
   private static int runNearbyTest(CommandSourceStack pSource, boolean pRerunUntilFailed) {
      ...
      if (blockpos1 == null) {
         ...
         runTest(serverlevel, blockpos1, (MultipleTestTracker)null, pRerunUntilFailed);
         return 1;
      }
   }
   ...
   private static int runAllNearbyTests(CommandSourceStack pSource, boolean pRerunUntilFailed) {
      ...
      if (collection.isEmpty()) {
         ...
         collection.forEach((p_308550_) -> {
            runTest(serverlevel, p_308550_, multipletesttracker, pRerunUntilFailed);
         });
         return 1;
      }
   }
   ...
   private static void say(ServerLevel pServerLevel, String pMessage, ChatFormatting pFormatting) {
      pServerLevel.getPlayers((p_127945_) -> {
         ...
         p_308546_.sendSystemMessage(Component.literal(pMessage).withStyle(pFormatting));
      });
   }
