...
public class ClientboundUpdateAdvancementsPacket implements Packet<ClientGamePacketListener> {
   ...
   public ClientboundUpdateAdvancementsPacket(boolean pReset, Collection<AdvancementHolder> pAdded, Set<ResourceLocation> pRemoved, Map<ResourceLocation, AdvancementProgress> pProgress) {
      this.reset = pReset;
   ...
   public void write(FriendlyByteBuf pBuffer) {
      ...
      pBuffer.writeCollection(this.added, (p_296407_, p_296408_) -> {
         p_296408_.write(p_296407_);
      });
