...
public class ClientboundUpdateMobEffectPacket implements Packet<ClientGamePacketListener> {
   ...
   public ClientboundUpdateMobEffectPacket(FriendlyByteBuf pBuffer) {
      ...
      this.factorData = pBuffer.readNullable((p_296415_) -> {
         return p_296415_.readWithCodecTrusted(NbtOps.INSTANCE, MobEffectInstance.FactorData.CODEC);
      });
   }
   ...
   public void write(FriendlyByteBuf pBuffer) {
      ...
      pBuffer.writeNullable(this.factorData, (p_296413_, p_296414_) -> {
         p_296413_.writeWithCodec(NbtOps.INSTANCE, MobEffectInstance.FactorData.CODEC, p_296414_);
      });
   }
