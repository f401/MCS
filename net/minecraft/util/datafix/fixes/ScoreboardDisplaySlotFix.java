...
public class ScoreboardDisplaySlotFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("Scoreboard DisplaySlot rename", type, (p_299538_) -> {
         return p_299538_.updateTyped(opticfinder, (p_297443_) -> {
            return p_297443_.update(DSL.remainderFinder(), (p_298932_) -> {
               return p_298932_.update("DisplaySlots", (p_299419_) -> {
                  return p_299419_.updateMapValues((p_298934_) -> {
                     return p_298934_.mapFirst((p_298032_) -> {
                        return DataFixUtils.orElse(p_298032_.asString().result().map(ScoreboardDisplaySlotFix::rename).map(p_298032_::createString), p_298032_);
                     });
                  });
               });
            });
