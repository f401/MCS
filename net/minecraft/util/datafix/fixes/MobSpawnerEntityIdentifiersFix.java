...
public class MobSpawnerEntityIdentifiersFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("MobSpawnerEntityIdentifiersFix", this.getInputSchema().getType(References.UNTAGGED_SPAWNER), type, (p_296634_) -> {
         Dynamic<?> dynamic = p_296634_.get(DSL.remainderFinder());
         ...
         return dataresult.result().isEmpty() ? p_296634_ : dataresult.result().get().getFirst();
      });
   }
}