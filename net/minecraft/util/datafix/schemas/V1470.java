...
public class V1470 extends NamespacedSchema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema pSchema) {
      ...
      pSchema.register(map, "minecraft:trident", (p_309012_) -> {
         return DSL.optionalFields("inBlockState", References.BLOCK_STATE.in(pSchema), "Trident", References.ITEM_STACK.in(pSchema));
      });
      return map;
   }
}