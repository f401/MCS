...
public class V1451_6 extends NamespacedSchema {
   ...
   protected static final Hook.HookFunction REPACK_OBJECTIVE_ID = new Hook.HookFunction() {
      public <T> T apply(DynamicOps<T> p_181105_, T p_181106_) {
         ...
         Optional<Dynamic<T>> optional = dynamic.get("CriteriaType").get().get().left().flatMap((p_296644_) -> {
            Optional<String> optional1 = p_296644_.get("type").asString().get().left();
            Optional<String> optional2 = p_296644_.get("id").asString().get().left();
            if (optional1.isPresent() && optional2.isPresent()) {
               String s = optional1.get();
               return s.equals("_special") ? Optional.of(dynamic.createString(optional2.get())) : Optional.of(p_296644_.createString(V1451_6.packNamespacedWithDot(s) + ":" + V1451_6.packNamespacedWithDot(optional2.get())));
            } else {
