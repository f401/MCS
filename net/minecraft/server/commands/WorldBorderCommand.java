...
public class WorldBorderCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> pDispatcher) {
      ...
      }).then(Commands.literal("add").then(Commands.argument("distance", DoubleArgumentType.doubleArg((double)-5.999997E7F, (double)5.999997E7F)).executes((p_296554_) -> {
         return setSize(p_296554_.getSource(), p_296554_.getSource().getLevel().getWorldBorder().getSize() + DoubleArgumentType.getDouble(p_296554_, "distance"), 0L);
      }).then(Commands.argument("time", IntegerArgumentType.integer(0)).executes((p_296553_) -> {
         return setSize(p_296553_.getSource(), p_296553_.getSource().getLevel().getWorldBorder().getSize() + DoubleArgumentType.getDouble(p_296553_, "distance"), p_296553_.getSource().getLevel().getWorldBorder().getLerpRemainingTime() + (long)IntegerArgumentType.getInteger(p_296553_, "time") * 1000L);
