...
public class PlaceCommand {
   ...
   public static int placeStructure(CommandSourceStack pSource, Holder.Reference<Structure> pStructure, BlockPos pPos) throws CommandSyntaxException {
      ...
      if (!structurestart.isValid()) {
         ...
         ChunkPos.rangeClosed(chunkpos, chunkpos1).forEach((p_296526_) -> {
            structurestart.placeInChunk(serverlevel, serverlevel.structureManager(), chunkgenerator, serverlevel.getRandom(), new BoundingBox(p_296526_.getMinBlockX(), serverlevel.getMinBuildHeight(), p_296526_.getMinBlockZ(), p_296526_.getMaxBlockX(), serverlevel.getMaxBuildHeight(), p_296526_.getMaxBlockZ()), p_296526_);
         });
