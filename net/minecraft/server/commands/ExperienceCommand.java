...
public class ExperienceCommand {
   ...
   static enum Type {
      POINTS("points", Player::giveExperiencePoints, (p_296497_, p_296498_) -> {
         if (p_296498_ >= p_296497_.getXpNeededForNextLevel()) {
            return false;
         } else {
            p_296497_.setExperiencePoints(p_296498_);
            return true;
         }
      }, (p_296499_) -> {
         return Mth.floor(p_296499_.experienceProgress * (float)p_296499_.getXpNeededForNextLevel());
      }),
