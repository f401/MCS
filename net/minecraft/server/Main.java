...
public class Main {
   ...
   private static WorldLoader.InitConfig loadOrCreateConfig(DedicatedServerProperties pDedicatedServerProperties, @Nullable Dynamic<?> pDynamic, boolean pSafeMode, PackRepository pPackRepository) {
      boolean flag;
