...
public interface ChunkTrackingView {
   ...
   static void difference(ChunkTrackingView pOldChunkTrackingView, ChunkTrackingView pNewChunkTrackingView, Consumer<ChunkPos> pChunkDropper, Consumer<ChunkPos> pChunkMarker) {
      if (!pOldChunkTrackingView.equals(pNewChunkTrackingView)) {
         if (pOldChunkTrackingView instanceof ChunkTrackingView.Positioned) {
            ChunkTrackingView.Positioned chunktrackingview$positioned = (ChunkTrackingView.Positioned)pOldChunkTrackingView;
            if (pNewChunkTrackingView instanceof ChunkTrackingView.Positioned) {
               ChunkTrackingView.Positioned chunktrackingview$positioned1 = (ChunkTrackingView.Positioned)pNewChunkTrackingView;
               if (chunktrackingview$positioned.squareIntersects(chunktrackingview$positioned1)) {
