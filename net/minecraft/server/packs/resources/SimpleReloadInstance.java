...
public class SimpleReloadInstance<S> implements ReloadInstance {
   ...
   protected SimpleReloadInstance(Executor pBackgroundExecutor, final Executor pGameExecutor, ResourceManager pResourceManager, List<PreparableReloadListener> pListeners, SimpleReloadInstance.StateFactory<S> pStateFactory, CompletableFuture<Unit> pAlsoWaitedFor) {
