...
public class Guardian extends Monster {
   ...
   public static boolean checkGuardianSpawnRules(EntityType<? extends Guardian> pGuardian, LevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, RandomSource pRandom) {
      return (pRandom.nextInt(20) == 0 || !pLevel.canSeeSkyFromBelowWater(pPos)) && pLevel.getDifficulty() != Difficulty.PEACEFUL && (MobSpawnType.isSpawner(pSpawnType) || pLevel.getFluidState(pPos).is(FluidTags.WATER)) && pLevel.getFluidState(pPos.below()).is(FluidTags.WATER);
   }
