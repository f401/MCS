...
public class Pufferfish extends AbstractFish {
   ...
   int inflateCounter;
   int deflateTimer;
   private static final Predicate<LivingEntity> SCARY_MOB = (p_296803_) -> {
      if (p_296803_ instanceof Player && ((Player)p_296803_).isCreative()) {
         return false;
      } else {
         return p_296803_.getType() == EntityType.AXOLOTL || p_296803_.getMobType() != MobType.WATER;
      }
   };
