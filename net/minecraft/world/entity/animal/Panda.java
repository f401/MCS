...
public class Panda extends Animal {
   ...
   static final Predicate<ItemEntity> PANDA_ITEMS = (p_296802_) -> {
      ItemStack itemstack = p_296802_.getItem();
      return (itemstack.is(Blocks.BAMBOO.asItem()) || itemstack.is(Blocks.CAKE.asItem())) && p_296802_.isAlive() && !p_296802_.hasPickUpDelay();
   };
