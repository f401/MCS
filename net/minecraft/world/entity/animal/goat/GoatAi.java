...
public class GoatAi {
   ...
   private static final TargetingConditions RAM_TARGET_CONDITIONS = TargetingConditions.forCombat().selector((p_296812_) -> {
      return !p_296812_.getType().equals(EntityType.GOAT) && p_296812_.level().getWorldBorder().isWithinBounds(p_296812_.getBoundingBox());
   });
   ...
   private static void initRamActivity(Brain<Goat> pBrain) {
      ...
      }, RAM_TARGET_CONDITIONS, 3.0F, (p_296811_) -> {
         return p_296811_.isBaby() ? 1.0D : 2.5D;
      }, (p_149468_) -> {
