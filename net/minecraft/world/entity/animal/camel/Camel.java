...
public class Camel extends AbstractHorse implements PlayerRideableJumping, Saddleable {
   ...
   protected Vector3f getPassengerAttachmentPoint(Entity pEntity, EntityDimensions pDimensions, float pScale) {
      ...
      boolean flag = i == 0;
      float f = 0.5F;
      float f1 = (float)(this.isRemoved() ? (double)0.01F : this.getBodyAnchorAnimationYOffset(flag, 0.0F, pDimensions, pScale));
   ...
   public Vec3 getLeashOffset(float pPartialTick) {
      ...
      return new Vec3(0.0D, this.getBodyAnchorAnimationYOffset(true, pPartialTick, entitydimensions, f) - (double)(0.2F * f), (double)(entitydimensions.width * 0.56F));
   }
