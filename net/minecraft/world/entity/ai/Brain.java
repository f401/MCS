...
public class Brain<E extends LivingEntity> {
   ...
   public boolean checkMemory(MemoryModuleType<?> pMemoryType, MemoryStatus pMemoryStatus) {
      ...
      if (optional == null) {
         ...
         return pMemoryStatus == MemoryStatus.REGISTERED || pMemoryStatus == MemoryStatus.VALUE_PRESENT && optional.isPresent() || pMemoryStatus == MemoryStatus.VALUE_ABSENT && optional.isEmpty();
      }
   }
