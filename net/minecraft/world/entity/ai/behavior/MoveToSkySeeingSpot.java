   ...
   public static OneShot<LivingEntity> create(float pSpeedModifier) {
      return BehaviorBuilder.create((p_258543_) -> {
         return p_258543_.group(p_258543_.absent(MemoryModuleType.WALK_TARGET)).apply(p_258543_, (p_258545_) -> {
            return (p_296718_, p_296719_, p_296720_) -> {
               if (p_296718_.canSeeSky(p_296719_.blockPosition())) {
                  return false;
               } else {
                  Optional<Vec3> optional = Optional.ofNullable(getOutdoorPosition(p_296718_, p_296719_));
