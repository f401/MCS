...
public class PrepareRamNearestTarget<E extends PathfinderMob> extends Behavior<E> {
   ...
   private void chooseRamPosition(PathfinderMob pPathfinder, LivingEntity pEntity) {
      ...
      this.ramCandidate = this.calculateRammingStartPosition(pPathfinder, pEntity).map((p_296722_) -> {
         return new PrepareRamNearestTarget.RamCandidate(p_296722_, pEntity.blockPosition(), pEntity);
      });
   }
