...
public class AnimalPanic extends Behavior<PathfinderMob> {
   ...
   private static final Predicate<PathfinderMob> DEFAULT_SHOULD_PANIC_PREDICATE = (p_296666_) -> {
      return p_296666_.getLastHurtByMob() != null || p_296666_.isFreezing() || p_296666_.isOnFire();
   };
