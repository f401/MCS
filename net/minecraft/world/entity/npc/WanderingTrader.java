...
public class WanderingTrader extends AbstractVillager {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(0, new UseItemGoal<>(this, PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.INVISIBILITY), SoundEvents.WANDERING_TRADER_DISAPPEARED, (p_296854_) -> {
         return this.level().isNight() && !p_296854_.isInvisible();
      }));
      this.goalSelector.addGoal(0, new UseItemGoal<>(this, new ItemStack(Items.MILK_BUCKET), SoundEvents.WANDERING_TRADER_REAPPEARED, (p_296853_) -> {
         return this.level().isDay() && p_296853_.isInvisible();
      }));
