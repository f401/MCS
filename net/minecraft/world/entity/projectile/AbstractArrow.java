...
public abstract class AbstractArrow extends Projectile {
   ...
   protected AbstractArrow(EntityType<? extends AbstractArrow> pEntityType, double pX, double pY, double pZ, Level pLevel, ItemStack pPickupItemStack) {
   ...
   protected AbstractArrow(EntityType<? extends AbstractArrow> pEntityType, LivingEntity pOwner, Level pLevel, ItemStack pPickupItemStack) {
      this(pEntityType, pOwner.getX(), pOwner.getEyeY() - (double)0.1F, pOwner.getZ(), pLevel, pPickupItemStack);
