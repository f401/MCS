...
public final class ProjectileUtil {
   ...
   private static HitResult getHitResult(Vec3 pPos, Entity pProjectile, Predicate<Entity> pFilter, Vec3 pDeltaMovement, Level pLevel, float pMargin, ClipContext.Block pClipContext) {
      ...
      HitResult hitresult1 = getEntityHitResult(pLevel, pProjectile, pPos, vec3, pProjectile.getBoundingBox().expandTowards(pDeltaMovement).inflate(1.0D), pFilter, pMargin);
      if (hitresult1 != null) {
