...
public class ShapedRecipe implements CraftingRecipe, net.minecraftforge.common.crafting.IShapedRecipe<CraftingContainer> {
   ...
   public ShapedRecipe(String pGroup, CraftingBookCategory pCategory, int pWidth, int pHeight, NonNullList<Ingredient> pRecipeItems, ItemStack pResult, boolean pShowNotification) {
      this.group = pGroup;
   ...
   public ShapedRecipe(String pGroup, CraftingBookCategory pCategory, int pWidth, int pHeight, NonNullList<Ingredient> pRecipeItems, ItemStack pResult) {
      this(pGroup, pCategory, pWidth, pHeight, pRecipeItems, pResult, true);
   }
   ...
   @VisibleForTesting
   static String[] shrink(List<String> pRecipe) {
      int i = Integer.MAX_VALUE;
      int j = 0;
      int k = 0;
      int l = 0;

      for(int i1 = 0; i1 < pRecipe.size(); ++i1) {
         String s = pRecipe.get(i1);
      ...
      if (pRecipe.size() == l) {
         ...
         String[] astring = new String[pRecipe.size() - l - k];

         for(int k1 = 0; k1 < astring.length; ++k1) {
            astring[k1] = pRecipe.get(k1 + k).substring(i, j + 1);
         }
