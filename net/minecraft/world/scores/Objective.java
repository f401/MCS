...
public class Objective {
   ...
   public Objective(Scoreboard pScoreboard, String pName, ObjectiveCriteria pCriteria, Component pDisplayName, ObjectiveCriteria.RenderType pRenderType, boolean pDisplayAutoUpdate, @Nullable NumberFormat pNumberFormat) {
