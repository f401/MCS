...
public class Path {
   ...
   public void writeToStream(FriendlyByteBuf pBuffer) {
      if (this.debugData != null && !this.debugData.targetNodes.isEmpty()) {
         ...
         pBuffer.writeCollection(this.nodes, (p_296986_, p_296987_) -> {
            p_296987_.writeToStream(p_296986_);
         });
   ...
   public static record DebugData(Node[] openSet, Node[] closedSet, Set<Target> targetNodes) {
      public void write(FriendlyByteBuf pBuffer) {
         pBuffer.writeCollection(this.targetNodes, (p_300614_, p_300157_) -> {
            p_300157_.writeToStream(p_300614_);
         });
