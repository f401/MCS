...
public class DimensionDataStorage {
   ...
   public CompoundTag readTagFromDisk(String pFilename, DataFixTypes pDataFixType, int pVersion) throws IOException {
      ...
      try (
         ...
         compoundtag1 = pDataFixType == null ? compoundtag : pDataFixType.update(this.fixerUpper, compoundtag, i, pVersion); // Forge: Allow the data fixer to be null, leaving the modder responsible for keeping track of their own data formats
      }
