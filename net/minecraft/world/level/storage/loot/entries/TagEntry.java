...
public class TagEntry extends LootPoolSingletonContainer {
   public static final Codec<TagEntry> CODEC = RecordCodecBuilder.create((p_297046_) -> {
      return p_297046_.group(TagKey.codec(Registries.ITEM).fieldOf("name").forGetter((p_297052_) -> {
         return p_297052_.tag;
      }), Codec.BOOL.fieldOf("expand").forGetter((p_297045_) -> {
         return p_297045_.expand;
      })).and(singletonFields(p_297046_)).apply(p_297046_, TagEntry::new);
   });
   ...
   public static LootPoolSingletonContainer.Builder<?> tagContents(TagKey<Item> pTag) {
      return simpleBuilder((p_297054_, p_297055_, p_297056_, p_297057_) -> {
         return new TagEntry(pTag, false, p_297054_, p_297055_, p_297056_, p_297057_);
      });
   }

   public static LootPoolSingletonContainer.Builder<?> expandTag(TagKey<Item> pTag) {
      return simpleBuilder((p_297048_, p_297049_, p_297050_, p_297051_) -> {
         return new TagEntry(pTag, true, p_297048_, p_297049_, p_297050_, p_297051_);
      });
   }
}