         ...
         if (this.spawnDelay > 0) {
            ...
            for(int i = 0; i < this.spawnCount; ++i) {
               ...
               if (pServerLevel.noCollision(optional.get().getAABB(d0, d1, d2))) {
                  ...
                  int k = pServerLevel.getEntities(EntityTypeTest.forExactClass(entity.getClass()), (new AABB((double)pPos.getX(), (double)pPos.getY(), (double)pPos.getZ(), (double)(pPos.getX() + 1), (double)(pPos.getY() + 1), (double)(pPos.getZ() + 1))).inflate((double)this.spawnRange), EntitySelector.NO_SPECTATORS).size();
