...
public class JigsawPlacement {
   ...
   private static void addPieces(RandomState pRandomState, int pMaxDepth, boolean pUseExpansionHack, ChunkGenerator pChunkGenerator, StructureTemplateManager pStructureTemplateManager, LevelHeightAccessor pLevel, RandomSource pRandom, Registry<StructureTemplatePool> pPools, PoolElementStructurePiece pCurrentPiece, List<PoolElementStructurePiece> pPieces, VoxelShape pFree) {
      ...
      jigsawplacement$placer.placing.addLast(new JigsawPlacement.PieceState(pCurrentPiece, new MutableObject<>(pFree), 0));
