...
public final class ReportingContext {
   ...
   public void draftReportHandled(Minecraft pMinecraft, Screen pScreen, Runnable pQuitter, boolean pQuitToTitle) {
      if (this.draftReport != null) {
         ...
         pMinecraft.setScreen(new ConfirmScreen((p_296240_) -> {
         ...
         }, Component.translatable(pQuitToTitle ? "gui.abuseReport.draft.quittotitle.title" : "gui.abuseReport.draft.title"), Component.translatable(pQuitToTitle ? "gui.abuseReport.draft.quittotitle.content" : "gui.abuseReport.draft.content"), Component.translatable("gui.abuseReport.draft.edit"), Component.translatable("gui.abuseReport.draft.discard")));
      } else {
         pQuitter.run();
      }
