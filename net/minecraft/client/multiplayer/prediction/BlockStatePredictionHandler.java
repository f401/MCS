...
public class BlockStatePredictionHandler implements AutoCloseable {
   ...
   public void retainKnownServerState(BlockPos pPos, BlockState pState, LocalPlayer pPlayer) {
      this.serverVerifiedStates.compute(pPos.asLong(), (p_308282_, p_308283_) -> {
         return p_308283_ != null ? p_308283_.setSequence(this.currentSequenceNr) : new BlockStatePredictionHandler.ServerVerifiedState(this.currentSequenceNr, pState, pPlayer.position());
      });
   }
