...
public class BlockStatePredictionHandler implements AutoCloseable {
   ...
   public void retainKnownServerState(BlockPos pPos, BlockState pState, LocalPlayer pPlayer) {
      this.serverVerifiedStates.compute(pPos.asLong(), (p_296243_, p_296244_) -> {
         return p_296244_ != null ? p_296244_.setSequence(this.currentSequenceNr) : new BlockStatePredictionHandler.ServerVerifiedState(this.currentSequenceNr, pState, pPlayer.position());
      });
   }
