...
public class DefaultPlayerSkin {
   ...
   private static PlayerSkin create(String pPath, PlayerSkin.Model pSkinModel) {
      return new PlayerSkin(new ResourceLocation(pPath), (String)null, (ResourceLocation)null, (ResourceLocation)null, pSkinModel, true);
   }
}