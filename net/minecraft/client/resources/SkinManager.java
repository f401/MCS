...
public class SkinManager {
   ...
   CompletableFuture<PlayerSkin> registerTextures(UUID pUuid, MinecraftProfileTextures pTextures) {
      ...
      return CompletableFuture.allOf(completablefuture, completablefuture1, completablefuture2).thenApply((p_308309_) -> {
         return new PlayerSkin(completablefuture.join(), s, completablefuture1.join(), completablefuture2.join(), playerskin$model, pTextures.signatureState() == SignatureState.SIGNED);
      });
   }
