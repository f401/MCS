...
public class ServerPackManager {
   ...
   public ServerPackManager(PackDownloader pDownloader, PackLoadFeedback pPackLoadFeedback, PackReloadConfig pReloadConfig, Runnable pUpdateRequest, ServerPackManager.PackPromptStatus pPackPromptStatus) {
   ...
   public void pushLocalPack(UUID pId, Path pPath) {
      if (this.packPromptStatus == ServerPackManager.PackPromptStatus.DECLINED) {
         ...
         ServerPackManager.ServerPackData serverpackmanager$serverpackdata = new ServerPackManager.ServerPackData(pId, url, (HashCode)null);
