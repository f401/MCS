...
public class TrialSpawnerDetectionParticle extends TextureSheetParticle {
   ...
   protected TrialSpawnerDetectionParticle(ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed, float pSizeMultiplier, SpriteSet pSprites) {
