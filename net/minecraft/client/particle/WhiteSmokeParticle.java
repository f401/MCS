...
public class WhiteSmokeParticle extends BaseAshSmokeParticle {
   ...
   protected WhiteSmokeParticle(ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed, float pQuadSizeMultiplier, SpriteSet pSprites) {
