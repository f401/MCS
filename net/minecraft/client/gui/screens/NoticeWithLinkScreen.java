...
public class NoticeWithLinkScreen extends Screen {
   ...
   public NoticeWithLinkScreen(Component pTitle, Component pMessage, String pUrl, @Nullable Screen pCallbackScreen) {
      super(pTitle);
   ...
   public static Screen createWorldSymlinkWarningScreen(@Nullable Screen pCallbackScreen) {
      return new NoticeWithLinkScreen(SYMLINK_WORLD_TITLE, SYMLINK_WORLD_MESSAGE_TEXT, "https://aka.ms/MinecraftSymLinks", pCallbackScreen);
   }

   public static Screen createPackSymlinkWarningScreen(@Nullable Screen pCallbackScreen) {
      return new NoticeWithLinkScreen(SYMLINK_PACK_TITLE, SYMLINK_PACK_MESSAGE_TEXT, "https://aka.ms/MinecraftSymLinks", pCallbackScreen);
   }
