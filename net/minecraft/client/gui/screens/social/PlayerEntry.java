...
public class PlayerEntry extends ContainerObjectSelectionList.Entry<PlayerEntry> {
   ...
   public PlayerEntry(Minecraft pMinecraft, SocialInteractionsScreen pSocialInteractionsScreen, UUID pId, String pPlayerName, Supplier<PlayerSkin> pSkinGetter, boolean pPlayerReportable) {
      ...
      if (flag1 && flag && !playersocialmanager.isBlocked(pId)) {
         this.reportButton = new ImageButton(0, 0, 20, 20, REPORT_BUTTON_SPRITES, (p_238875_) -> {
            reportingcontext.draftReportHandled(pMinecraft, pSocialInteractionsScreen, () -> {
               pMinecraft.setScreen(new ReportPlayerScreen(pSocialInteractionsScreen, reportingcontext, this));
            }, false);
