...
public class ReportPlayerScreen extends Screen {
   ...
   protected void init() {
      ...
      Button button = this.layout.addChild(Button.builder(REPORT_CHAT, (p_297615_) -> {
      ...
      this.layout.addChild(Button.builder(REPORT_SKIN, (p_299324_) -> {
      ...
      this.layout.addChild(Button.builder(REPORT_NAME, (p_298210_) -> {
      ...
      this.layout.addChild(Button.builder(CommonComponents.GUI_CANCEL, (p_299500_) -> {
         this.onClose();
      }).build());
      this.layout.visitWidgets((p_298152_) -> {
         AbstractWidget abstractwidget = this.addRenderableWidget(p_298152_);
      });
