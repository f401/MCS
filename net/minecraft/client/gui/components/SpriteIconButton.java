...
public abstract class SpriteIconButton extends Button {
   ...
   public static class Builder {
      ...
      public SpriteIconButton build() {
         if (this.sprite == null) {
            ...
            return (SpriteIconButton)(this.iconOnly ? new SpriteIconButton.CenteredIcon(this.width, this.height, this.message, this.spriteWidth, this.spriteHeight, this.sprite, this.onPress) : new SpriteIconButton.TextAndIcon(this.width, this.height, this.message, this.spriteWidth, this.spriteHeight, this.sprite, this.onPress));
         }
      }
   }
   ...
   public static class CenteredIcon extends SpriteIconButton {
      protected CenteredIcon(int p_300200_, int p_299056_, Component p_298209_, int p_300001_, int p_298255_, ResourceLocation p_298326_, Button.OnPress p_298485_) {
         super(p_300200_, p_299056_, p_298209_, p_300001_, p_298255_, p_298326_, p_298485_);
      }
   ...
   public static class TextAndIcon extends SpriteIconButton {
      protected TextAndIcon(int p_299028_, int p_300372_, Component p_297448_, int p_300274_, int p_301370_, ResourceLocation p_298996_, Button.OnPress p_298623_) {
         super(p_299028_, p_300372_, p_297448_, p_300274_, p_301370_, p_298996_, p_298623_);
      }
