...
public class Frustum {
   ...
   public Frustum offsetToFullyIncludeCameraCube(int pOffset) {
      ...
      for(double d5 = Math.ceil(this.camZ / (double)pOffset) * (double)pOffset; this.intersection.intersectAab((float)(d0 - this.camX), (float)(d1 - this.camY), (float)(d2 - this.camZ), (float)(d3 - this.camX), (float)(d4 - this.camY), (float)(d5 - this.camZ)) != -2; this.camZ -= (double)(this.viewVector.z() * 4.0F)) {
