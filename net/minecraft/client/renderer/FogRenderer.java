...
public class FogRenderer {
   ...
   private static FogRenderer.MobEffectFogFunction getPriorityFogFunction(Entity pEntity, float pPartialTick) {
      if (pEntity instanceof LivingEntity livingentity) {
         return MOB_EFFECT_FOG.stream().filter((p_234171_) -> {
            return p_234171_.isEnabled(livingentity, pPartialTick);
   ...
   public static void setupFog(Camera pCamera, FogRenderer.FogMode pFogMode, float pFarPlaneDistance, boolean pShouldCreateFog, float pPartialTick) {
      ...
      net.minecraftforge.client.ForgeHooksClient.onFogRender(pFogMode, fogtype, pCamera, pPartialTick, pFarPlaneDistance, fogrenderer$fogdata.start, fogrenderer$fogdata.end, fogrenderer$fogdata.shape);
   }
