...
public class RealmsCreateRealmScreen extends RealmsScreen {
   ...
   public RealmsCreateRealmScreen(RealmsMainScreen pLastScreen, RealmsServer pRealmsServer) {
      ...
      this.createWorldRunnable = () -> {
         this.createWorld(pRealmsServer);
      };
   }
   ...
   public RealmsCreateRealmScreen(RealmsMainScreen pLastScreen, long pParentId) {
      ...
      this.lastScreen = pLastScreen;
      this.createWorldRunnable = () -> {
         this.createSnapshotWorld(pParentId);
      };
   }
   ...
   private void createWorld(RealmsServer pRealmsServer) {
      ...
      RealmsResetWorldScreen realmsresetworldscreen = RealmsResetWorldScreen.forNewRealm(this, pRealmsServer, worldcreationtask, () -> {
   ...
   private void createSnapshotWorld(long pParentId) {
      Screen screen = new RealmsResetNormalWorldScreen((p_308056_) -> {
         if (p_308056_ == null) {
            ...
            this.minecraft.setScreen(new RealmsLongRunningMcoTaskScreen(this, new CreateSnapshotRealmTask(this.lastScreen, pParentId, p_308056_, this.nameBox.getValue(), this.descriptionBox.getValue())));
         }
      }, CREATE_REALM_TEXT);
