...
public class RealmsSelectWorldTemplateScreen extends RealmsScreen {
   ...
   Either<WorldTemplatePaginatedList, Exception> fetchTemplates(WorldTemplatePaginatedList p_89656_, RealmsClient pRealmsClient) {
      try {
   ...
   class Entry extends ObjectSelectionList.Entry<RealmsSelectWorldTemplateScreen.Entry> {
      ...
      public Entry(WorldTemplate pTemplate) {
         ...
         if (!pTemplate.link.isBlank()) {
            this.websiteButton = new ImageButton(15, 15, WEBSITE_LINK_SPRITES, ConfirmLinkScreen.confirmLink(pTemplate.link, RealmsSelectWorldTemplateScreen.this, true), PUBLISHER_LINK_TOOLTIP);
            this.websiteButton.setTooltip(Tooltip.create(PUBLISHER_LINK_TOOLTIP));
         }

         if (!pTemplate.trailer.isBlank()) {
            this.trailerButton = new ImageButton(15, 15, TRAILER_LINK_SPRITES, ConfirmLinkScreen.confirmLink(pTemplate.trailer, RealmsSelectWorldTemplateScreen.this, true), TRAILER_LINK_TOOLTIP);
      ...
      public void render(GuiGraphics pGuiGraphics, int pIndex, int pTop, int pLeft, int pWidth, int pHeight, int pMouseX, int pMouseY, boolean pHovering, float pPartialTick) {
         pGuiGraphics.blit(RealmsTextureManager.worldTemplate(this.template.id, this.template.image), pLeft + 1, pTop + 1 + 1, 0.0F, 0.0F, 38, 38, 38, 38);
