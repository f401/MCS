...
public class RealmsResetWorldScreen extends RealmsScreen {
   ...
   private RealmsResetWorldScreen(Screen pLastScreen, RealmsServer pServerData, int pSlot, Component pTitle, Component pSubtitle, int pSubtitleColor, Component pResetTaskTitle, Runnable pResetWorldRunnable) {
      this(pLastScreen, pServerData, pSlot, pTitle, pSubtitle, pSubtitleColor, pResetTaskTitle, (WorldCreationTask)null, pResetWorldRunnable);
   }

   public RealmsResetWorldScreen(Screen pLastScreen, RealmsServer pServerData, int pSlot, Component pTitle, Component pSubtitle, int pSubtitleColor, Component pResetTaskTitle, @Nullable WorldCreationTask pWorldCreationTask, Runnable pResetWorldRunnable) {
      super(pTitle);
   ...
   public static RealmsResetWorldScreen forNewRealm(Screen pLastScreen, RealmsServer pServerData, WorldCreationTask pWorldCreationTask, Runnable pResetWorldRunnable) {
      return new RealmsResetWorldScreen(pLastScreen, pServerData, pServerData.activeSlot, CREATE_REALM_TITLE, CREATE_REALM_SUBTITLE, -6250336, CREATE_WORLD_RESET_TASK_TITLE, pWorldCreationTask, pResetWorldRunnable);
   }
