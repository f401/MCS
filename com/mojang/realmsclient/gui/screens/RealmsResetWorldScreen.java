...
public class RealmsResetWorldScreen extends RealmsScreen {
   ...
   public static RealmsResetWorldScreen forNewRealm(Screen pLastScreen, RealmsServer pServerData, Runnable pResetWorldRunnable) {
      return new RealmsResetWorldScreen(pLastScreen, pServerData, pServerData.activeSlot, CREATE_REALM_TITLE, CREATE_REALM_SUBTITLE, -6250336, CREATE_WORLD_RESET_TASK_TITLE, pResetWorldRunnable);
   }
