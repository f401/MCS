...
public class RealmsNotification {
   ...
   private static RealmsNotification parse(JsonObject pJson) {
      ...
      if (uuid == null) {
         ...
         switch (s) {
            case "visitUrl":
               object = RealmsNotification.VisitUrl.parse(realmsnotification, pJson);
               break;
            case "infoPopup":
               object = RealmsNotification.InfoPopup.parse(realmsnotification, pJson);
               break;
            default:
   ...
   public static class InfoPopup extends RealmsNotification {
      ...
      public PopupScreen buildScreen(Screen pBackgroundScreen, Consumer<UUID> pUuidOutput) {
         ...
         if (component == null) {
            ...
            PopupScreen.Builder popupscreen$builder = (new PopupScreen.Builder(pBackgroundScreen, component)).setImage(this.image).setMessage(this.message.createComponent(CommonComponents.EMPTY));
