...
public class RealmsServer extends ValueObject {
   ...
   public static RealmsServer parse(JsonObject pJson) {
      ...
      try {
         ...
         realmsserver.parentWorldName = JsonUtils.getStringOr("parentWorldName", pJson, (String)null);
