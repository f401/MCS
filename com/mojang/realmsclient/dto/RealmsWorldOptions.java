...
public class RealmsWorldOptions extends ValueObject {
   ...
   public RealmsWorldOptions(boolean pPvp, boolean pSpawnAnimals, boolean pSpawnMonsters, boolean pSpawnNPCs, int pSpawnProtection, boolean pCommandBlocks, int pDifficulty, int pGameMode, boolean pForceGameMode, String pSlotName, String pVersion, RealmsServer.Compatibility pCompatibility) {
      this.pvp = pPvp;
